...
if { [lsearch $cells1 {user_proj_IMPACT_HEAD}] >= 0 } {
#puts stdout "Flattening user_proj_IMPACT_HEAD in layout"
flatten class {-circuit1 user_proj_IMPACT_HEAD}
}
if { [lsearch $cells2 {user_proj_IMPACT_HEAD}] >= 0 } {
#puts stdout "Flattening user_proj_IMPACT_HEAD in source"
flatten class {-circuit2 user_proj_IMPACT_HEAD}
}
